...
// Copyright (c) 2015 The FreedomCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("freedomcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("freedomcoin-smsg-pow"); // Make this thread recognisable
